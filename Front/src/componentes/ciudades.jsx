...
export default function LocationSelector({ onLocationChange }) {
  ...
  const CITY_API_KEY = import.meta.env.VITE_CITY_API_KEY; // Replace with your actual API key
  const CITY_API_URL = import.meta.env.VITE_CITY_API_URL;
  const CITY_API_MAIL = import.meta.env.VITE_CITY_API_MAIL;
